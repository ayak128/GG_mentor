...
public class Method extends HttpServlet {
    ...
    // -----------------------------------------------    
    // メソッドの定義
    // 引数と戻り値のないメソッドで、メソッド名は「ohayo」です
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            // -----------------------------------------------        
            // メソッドの呼び出し
            // ohayoメソッドは「引数なし」なので、()の中に値をなにも渡さずに呼び出します
            // -----------------------------------------------
            ohayo();
            ...
            // ohayoメソッドを定義しましたが、processRequestメソッドより下に
            // ohayoメソッドを定義して、呼び出すことも可能です
            // 定義したohayoメソッドを切り取り、processRequestメソッドの外
